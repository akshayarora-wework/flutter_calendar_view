      ...
      child: SizedBox(
        ...
        child: DecoratedBox(
          ...
          child: Column(
            ...
            children: [
              if (widget.showHeader) _weekHeaderBuilder(_currentStartDate, _currentEndDate),
              Expanded(
                child: SizedBox(
                  height: _height,
                  width: _width,
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return ValueListenableBuilder(
                        ...
                        builder: (_, __, ___) => InternalWeekViewPage<T>(
                          ...
                          onEventChanged: (event) => widget.onEventChanged?.call(event),
          ...
          for (int i = 0; i < slots; i++)
            Positioned(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  if (controller.selectedEventNotifier?.value != null) {
